			...
			if ( $order_status != 'failed' ) {
				...
				foreach ( $order->get_items() as $item_id => $item_values ) {
					...
					if ( get_post_type( $wbtm_bus_id ) == 'wbtm_bus' ) {
						...
						$extra_bag                 = MP_Global_Function::get_order_item_meta( $item_id, 'Extra Bag' );
						$wbtm_tp                   = MP_Global_Function::get_order_item_meta( $item_id, '_wbtm_tp' );
				...
				jQuery.ajax({
					...
					beforeSend: function () {
						jQuery('#wbtm_search_result_section').html(
							'<span class=wbtm-loading-animation><img src="<?php echo WBTM_PLUGIN_URL . '/assets/helper/images/'; ?>loading.gif"</span>'
						);
					},
					success: function (data) {
