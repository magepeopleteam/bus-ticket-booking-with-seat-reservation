...
function wbtm_bus_panel_menu_items( $items ) {
	$new_items = array();
	$new_items['bus-panel'] = __( 'Bus Ticket', 'bus-ticket-booking-with-seat-reservation' );
    ...
    <table>
        ...
        <tbody>
            ...
            while($passengers->have_posts()) :
                ...
                ?>
            <tr>
                <td><a href="<?php echo $myaccount_link.'view-order/'.$order_id; ?>">#<?php echo $order_id; ?></a></td>
...
function wbtm_bus_panel_endpoint_title( $title ) {
	...
	if ( $is_endpoint && ! is_admin() && is_main_query() && in_the_loop() && is_account_page() ) {
		// New page title.
		$title = __( 'Bus Ticket', 'bus-ticket-booking-with-seat-reservation' );
