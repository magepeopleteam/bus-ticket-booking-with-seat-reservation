	...
	if ( ! class_exists( 'WBTM_Required_Plugins' ) ) {
		class WBTM_Required_Plugins {
			...
			public function wbtm_plugins_admin_menu() {
				add_submenu_page( $this->wbtm_plugin_page_location(), __( 'Install WBTM Plugins', 'bus-ticket-booking-with-seat-reservation' ), __( 'Install WBTM Plugins', 'bus-ticket-booking-with-seat-reservation' ), 'manage_options', 'wbtm-plugins', array( $this, 'wbtm_plugin_page' ) );
			}
			...
			public function wbtm_plugin_page() {
				...
				<div class="wrap wbtm_plugin_page_wrap">
					<table>
						<thead>
						<tr>
							<th colspan="2"><?php esc_html_e( '	Bus Ticket Booking with Seat Reservation Required Plugins', 'bus-ticket-booking-with-seat-reservation' ); ?></th>
						</tr>
						</thead>
						<tbody>
						<tr>
						...
						<tr>
							<td><?php esc_html_e( 'Bus Ticket Booking with Seat Reservation', 'bus-ticket-booking-with-seat-reservation' ); ?></td>
