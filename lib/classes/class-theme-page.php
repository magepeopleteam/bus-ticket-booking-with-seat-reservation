...
if (!class_exists("AddThemePage")) {
    class AddThemePage
    {
        ...
        public function section_callback($section)
        {
            ...
            $data = isset($section["callback"][0]->data)
                ? $section["callback"][0]->data
                : [];
        ...
        public function field_generator($option)
        {
            ...
            if (!empty($prent_option_name)):
                ...
                $option["value"] = isset($prent_option_value[$id])
                    ? $prent_option_value[$id]
                    : "";
            else:
            ...
            if (isset($option["type"]) && $option["type"] === "text") {
                ...
                isset($option["type"]) &&
                $option["type"] === "color_palette_multi"
            ) {
        ...
        public function whitelist_options($whitelist_options)
        {
            ...
            if ($prent_option_name):
                ...
                foreach ($this->get_pages() as $page_id => $page):
                    foreach ($page["page_settings"] as $section):
                        foreach ($section["options"] as $option):
                            $whitelist_options[$this->get_menu_slug()][] =
                                $option["id"];
                        endforeach;
                    endforeach;
                endforeach;
        ...
        public function display_function()
        {
            ...
            settings_errors();
            ?>
            <div class="wbtm_settings_wrapper">
                ...
                <div class='navigation'>
                    <ul class="nav-items">
                        ...
                        foreach ($this->get_pages() as $page_id => $page):
                            ...
                            $page_settings = !empty($page["page_settings"])
                                ? $page["page_settings"]
                                : [];
                            ...
                            <li class="nav-item-wrap <?php if (
                                ...
                                <a dataid="<?php echo $page_id; ?>" href='#<?php //echo $pagenow.'?'.$nav_menu_url;

                            echo $page_id; ?>' class="nav-item <?php if (
    $current_page == $page_id
) {
    echo "active";
} ?>"><?php echo $page["page_nav"]; ?>
                                ...
                                <?php if ($page_settings_count > 1): ?>
                                    <ul class="child-navs">
                                        <?php foreach (
                                            $page_settings
                                            as $section_id => $nav_sections
                                        ):
                                            $nav_sections_title = !empty(
                                                $nav_sections["nav_title"]
                                            )
                                                ? $nav_sections["nav_title"]
                                                : $nav_sections["title"];
                                            ...
                                            ?>
                                            <li>
                                                <a sectionId="<?php echo $section_id; ?>" dataid="<?php echo $page_id; ?>" href='#<?php //echo $pagenow.'?'.$nav_menu_url;
    ...
    echo "active";
                    ...
                    <div class="nav-footer">
                        <?php do_action("nav_footer_top"); ?>

                        <?php do_action("nav_footer_bottom"); ?>
                    </div>
                ...
                <div class="form-wrapper">
                    <form class="" action='options.php' method='post'>
                        ...
                        <div class="form-section">
                            ...
                            foreach (
                                $this->get_pages()
                                as $panelsIndex => $panels
                            ): ?>
                                <div class="tab-content <?php if (
                                    $current_page == $panelsIndex
                                ) {
                                    echo "active";
        ...
        {
            if (isset($this->data["settings_name"])) {
                return $this->data["settings_name"];
            } else {
        ...
        {
            if (
                isset($this->data["add_in_menu"]) &&
                $this->data["add_in_menu"]
            ) {
                return true;
            } else {
                return false;
        ...
        {
            if (isset($this->data["option_id"]) && $this->data["option_id"]) {
