...
*/
	...
	if ( ! class_exists( 'WBTM_Functions' ) ) {
		class WBTM_Functions {
            ...
            public static function wbtm_left_filter_disppaly( $bus_types, $bus_titles, $start_route ): void {
                ?>
                <div id="wbtm_bus_filter-options">
                    ...
                    <div class="wbtm_bus_filter_items">
                            ...
                            foreach ( $search_bus_types as $bus_type) {
                                ...
                                <div class="wbtm_bus_left_filter_checkbox_holder">
                                    <input type="checkbox" class="filter-checkbox" data-filter="wbtm_bus_type" value="<?php echo esc_attr( $bus_type );?>">
                    ...
                    <?php }?>
                    <div class="wbtm_bus_filter_items">
                        <span class="wbtm_bus_toggle-header">Dropping Point <span class="wbtm_bus_toggle-icon"></span></span>
                        <div class="wbtm_bus_left_filter_checkbox_holder">
                            <input type="checkbox" class="filter-checkbox" data-filter="wbtm_bus_start_route" value="<?php echo esc_attr($start_route); ?>">
