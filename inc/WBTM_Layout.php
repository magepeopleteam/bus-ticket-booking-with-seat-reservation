						...
						if ($all_info['available_seat'] > 0) {
                            ...
                            <div class="wbtm_registration_area _bgWhite mT">
                                <form action="" method="post" class="">
                                    ...
                                    <input type="hidden" name='bus_start_route' value='<?php echo esc_attr(isset($_POST['bus_start_route']) ? sanitize_text_field(wp_unslash($_POST['bus_start_route'])) : ''); ?>'/>
                                    <input type="hidden" name='bus_end_route' value='<?php echo esc_attr(isset($_POST['bus_end_route']) ? sanitize_text_field(wp_unslash($_POST['bus_end_route'])) : ''); ?>'/>
