<?php
	...
	if ( ! class_exists( 'WBTM_Setting_API' ) ) {
		class WBTM_Setting_API {
			...
			function callback_wbtm_select2( $args ) {
				...
				?>
                <label>
                    <select name="<?php echo esc_attr( $name ); ?>" class="formControl wbtm_select2">
			...
			function callback_wbtm_select2_role( $args ) {
				global $wp_roles;
				$value = WBTM_Global_Function::get_settings( $args['section'], $args['id'], $args['std'] );
				$name  = $args['section'] . '[' . $args['id'] . '][]';
				...
				?>
                <label>
                    <select name="<?php echo esc_attr( $name ); ?>" class="formControl wbtm_select2" multiple>
			...
			function callback_pages( $args ) {
				$dropdown_args = array(
					'selected' => WBTM_Global_Function::get_settings( $args['section'], $args['id'], $args['std'] ),
					'name'     => $args['section'] . '[' . $args['id'] . ']',
