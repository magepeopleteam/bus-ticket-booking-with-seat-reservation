	...
	if (!class_exists( 'WBTM_Global_File_Load' )) {
		class WBTM_Global_File_Load {
			...
			public function global_enqueue() {
				...
				wp_enqueue_style('mp_font_awesome', WBTM_GLOBAL_PLUGIN_URL . '/assets/admin/all.min.css', array(), '5.15.4');
			...
			public function admin_enqueue() {
				...
				//loading Time picker
				wp_enqueue_style('jquery.timepicker.min', WBTM_GLOBAL_PLUGIN_URL.'/assets/time_picker/jquery.timepicker.min.css');
