        ...
        class WBTM_Quick_Setup {
            ...
            public function quick_setup_menu() {
                ...
                if ( $status === 'yes' ) {
                    ...
                    add_menu_page( esc_html__( 'Flight', 'bus-ticket-booking-with-seat-reservation' ), esc_html__( 'Flight', 'bus-ticket-booking-with-seat-reservation' ), 'manage_options', 'wbtm_bus', array( $this, 'quick_setup' ), 'dashicons-admin-site-alt2', 6 );
