                ...
                <div class="wrap wbtm_welcome_wrap">
                    ...
                    <div class="wbtm-tabs-container">
                        ...
                        <div class="wbtm-tabs-content">
                            ...
                            <!-- Documents Tab: the full handbook now lives in its own
                                 submenu (Bus -> Documents) so the free and PRO docs stay
                            ...
                            <div id="tab-documents" class="wbtm-tab-pane">
                                ...
                                <p style="margin-bottom:18px;"><?php esc_html_e('The complete handbook — every screen, every field and every setting, with screenshots — now has its own page. PRO chapters are included there too, so you can see exactly what the addon adds.', 'bus-ticket-booking-with-seat-reservation'); ?></p>
                                <p>
                                    <a class="wbtm-btn" href="<?php echo esc_url(admin_url('edit.php?post_type=' . WBTM_Functions::get_cpt() . '&page=wbtm_docs_page')); ?>">
                                        <i class="fas fa-book-open"></i> <?php esc_html_e('Open Documents', 'bus-ticket-booking-with-seat-reservation'); ?>
                                    </a>
                                </p>
                            </div>
