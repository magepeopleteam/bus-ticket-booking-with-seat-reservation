	...
	if ( ! class_exists( 'WBTM_Global_settings' ) ) {
		class WBTM_Global_settings {
			...
			public function __construct() {
				...
				add_filter( 'wbtm_settings_sec_reg', array( $this, 'settings_sec_reg' ), 10 );
				add_filter( 'wbtm_settings_sec_fields', array( $this, 'settings_sec_fields' ), 10 );
			}
			...
			public function settings_sec_reg( $default_sec ): array {
				$sections = array(
					array(
						...
						'title' => __( 'General Settings', 'bus-ticket-booking-with-seat-reservation' )
					),
					array(
