		...
		class WBTM_Tax_Settings {
			...
			public function tab_content($post_id) {
				...
				<div class="tabsItem" data-tabs="#wbtm_settings_tax">
					...
					<p><?php esc_html_e('Tax Configuration', 'bus-ticket-booking-with-seat-reservation'); ?></p>
					<?php
					...
					<div class="_dLayout_padding_bgLight">
						<div class="col_6 _dFlex_fdColumn">
							<label>
								<?php esc_html_e('Tax Settings', 'bus-ticket-booking-with-seat-reservation'); ?> 
							</label>
					...
					<?php }else{ ?>
						<div class="_dLayout_dFlex_justifyCenter">
							<label class="_textCenter"><?php esc_html_e('Tax not Active', 'bus-ticket-booking-with-seat-reservation'); ?></label>
						</div>
					<?php } ?>
				</div>
				<?php
