				...
				<div class="wbtm-offdates-inner">
					<table class="repeatable-fieldset-offday">
						...
						<?php
							if ($wbtm_offday_schedule) :
								...
								foreach ($wbtm_offday_schedule as $field) {
									...
									<tr class="">
										<td align="left">
											<input type="text" id="<?php echo 'db_offday_from_' . $count; ?>" class="repeatable-offday-from-field" name='wbtm_od_offdate_from[]' placeholder="mm-dd" value="<?php echo $field['from_date'] ?>"/>
										</td>
										<td align="left">
											<input type="text" id="<?php echo 'db_offday_to_' . $count; ?>" class="repeatable-offday-to-field" name='wbtm_od_offdate_to[]' placeholder="mm-dd" value="<?php echo $field['to_date'] ?>"/>
										</td>
										<td align="left">
						...
						<tr class="empty-row-offday screen-reader-text">
							<td align="left">
								<input type="text" class="repeatable-offday-from-field" name='wbtm_od_offdate_from[]' placeholder="mm-dd"/>
							</td>
							<td align="left">
								<input type="text" class="repeatable-offday-to-field" name='wbtm_od_offdate_to[]' placeholder="mm-dd"/>
							</td>
							<td align="left">
								<a class="button remove-bp-row" href="#">
									<i class="fas fa-minus-circle"></i>
					...
					<p style="margin: 0 0 0 4px;border-radius: 5px;">
						<a class="button add-offday-row" href="#">
