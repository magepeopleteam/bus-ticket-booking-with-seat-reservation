...
<div id="wbtm_show_dropping_time" class="wbtm-item-row">
	...
	<input type="radio" id="show_boarding_time_no" name="show_boarding_time" <?php echo(($show_boarding_time == "no" || $show_boarding_time == '') ? " checked" : ""); ?> value="no">
	<label for="show_boarding_time_no"> <?php _e('No', 'bus-ticket-booking-with-seat-reservation') ?></label>
	<input type="radio" id="show_boarding_time_yes" name="show_boarding_time" <?php echo($show_boarding_time == "yes" ? " checked" : ""); ?> value="yes" style="margin-left: 20px">
	<label for="show_boarding_time_yes"> <?php _e('Yes', 'bus-ticket-booking-with-seat-reservation') ?></label>
</div>
<div id="wbtm_show_dropping_time" class="wbtm-item-row">
	<label class="item-label"><?php _e("Show dropping time", "bus-ticket-booking-with-seat-reservation") ?></label>
	<input type="radio" id="show_dropping_time_no" name="show_dropping_time" <?php echo(($show_dropping_time == "no" || $show_dropping_time == '') ? " checked" : ""); ?> value="no">
	<label for="show_dropping_time_no"> <?php _e('No', 'bus-ticket-booking-with-seat-reservation') ?></label>
	<input type="radio" id="show_dropping_time_yes" name="show_dropping_time" <?php echo($show_dropping_time == "yes" ? " checked" : ""); ?> value="yes" style="margin-left: 20px">
	<label for="show_dropping_time_yes"> <?php _e('Yes', 'bus-ticket-booking-with-seat-reservation') ?></label>
</div>
...
<div id="wbtm_zero_price_allow" class="wbtm-item-row">
	...
	<input type="radio" id="zero_price_allow_no" name="zero_price_allow" <?php echo(($zero_price_allow == "no" || $zero_price_allow == '') ? " checked" : ""); ?> value="no">
	<label for="zero_price_allow_no"> <?php _e('No', 'bus-ticket-booking-with-seat-reservation') ?></label>
	<input type="radio" id="zero_price_allow_yes" name="zero_price_allow" <?php echo($zero_price_allow == "yes" ? " checked" : ""); ?> value="yes" style="margin-left: 20px">
	<label for="zero_price_allow_yes"> <?php _e('Yes', 'bus-ticket-booking-with-seat-reservation') ?></label>
</div>
<div class="wbtm-seat-plan-wrapper">
	...
	<div class="wbtm-lower-bus-seat-maker-wrapper">
		<div class="wbtm-control-part">
			...
			<p class="wbtm-control-row">
				<button id="create_seat_plan" class="create_seat_plan">
					<span class="dashicons dashicons-plus"></span><?php _e('Create Seat Plan', 'bus-ticket-booking-with-seat-reservation'); ?>
				</button>
			</p>
		</div>
							...
							<?php
								foreach ($seats as $_seats) {
									...
									<tr>
										...
										?>
										<td align="center">
											<a class="button remove-seat-row" href="#"><?php _e('Remove', 'bus-ticket-booking-with-seat-reservation'); ?>
											</a>
		...
		<div class="wbtm-lower-bus-seat-maker-wrapper">
			<div class="wbtm-control-part">
				...
				<p class="wbtm-control-row" style="position: relative">
					...
					<span style="position: absolute;right: 0px;top: 15px;color: #555;font-weight:bold">%</span>
				</p>
				<p class="wbtm-control-row">
					<button id="create_seat_plan_dd" class="create_seat_plan">
						<span class="dashicons dashicons-plus"></span><?php _e('Create Seat Plan', 'bus-ticket-booking-with-seat-reservation'); ?>
					</button>
				</p>
			</div>
				...
				<div id="seat_result_dd">
					<?php
						if (array_key_exists('wbtm_bus_seats_info_dd', $values)) {
							...
							<div id="add-seat-row-dd" class="add-seat-row-btn">
								<i class="fas fa-plus"></i> <?php _e('Add Seat Row', 'bus-ticket-booking-with-seat-reservation'); ?></div>
						<?php } ?>
				</div>
			</div>
		</div>
