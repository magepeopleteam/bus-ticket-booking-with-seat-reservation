			...
			public function enqueue() {
				...
				wp_localize_script(
					...
					array(
						...
						'errorTxt'=> esc_html__( 'Couldn’t save in background — saving…', 'bus-ticket-booking-with-seat-reservation' ),
						...
						'publishTxt'=> esc_html__( 'Publish', 'bus-ticket-booking-with-seat-reservation' ),
						'publishedTxt'=> esc_html__( 'Published', 'bus-ticket-booking-with-seat-reservation' ),
						'draftTxt'=> esc_html__( 'Draft', 'bus-ticket-booking-with-seat-reservation' ),
						'switchDraftTxt'=> esc_html__( 'Switch to Draft', 'bus-ticket-booking-with-seat-reservation' ),
						'saveDraftTxt'=> esc_html__( 'Save Draft', 'bus-ticket-booking-with-seat-reservation' ),
