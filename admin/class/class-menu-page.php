	...
	'page_settings' => array(
        ...
        'section_0' => array(
            ...
            'options' 	=> array(
                ...
                array(
                    'id'		=> 'option_group',
                    'title'		=> __('Option group','text-domain'),
                    'details'	=> __('Description of Option group  field','text-domain'),
                    'type'		=> 'option_group',
                ...
                array(
                    ...
                    'title'		=> __('Option group tabs','text-domain'),
                    'details'	=> __('Description of Option group tabs field','text-domain'),
...
$args = array(
	'add_in_menu'       => true,
	'menu_type'         => 'main',
    'menu_name'         => __( 'Custom Settings', 'text-domain' ),
	'menu_title'        => __( 'Custom Settings', 'text-domain' ),
	'page_title'        => __( 'Custom Settings', 'text-domain' ),
	'menu_page_title'   => __( 'Custom Settings', 'text-domain' ),

	'capability'        => "manage_options",
	'menu_slug'         => "custom-menu",
    'option_name'       => "custom_pickoptions",
    'menu_icon'         => "dashicons-image-filter",

    'item_name'         => "MagePlugins",
    'item_version'      => "1.0.0",
    'panels' 	        => apply_filters('mage_menu_setings_panels', array(
		'panelGroup-1'        => $page_1_options,
        'panelGroup-2'        => $page_2_options,
        'panelGroup-3'        => $page_3_options,
        'panelGroup-4'        => $page_4_options,
        'panelGroup-5'        => $page_5_options,

    )),
);

$AddMenuPage = new AddMenuPage( $args );