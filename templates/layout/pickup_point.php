				...
				if (sizeof($pickup_infos) > 0) {
					...
					<div class="wbtm_pickup_point">
						...
						<label class="justifyBetween">
							...
							<select class="formControl" name="wbtm_pickup_point" required>
								<option disabled><?php echo WBTM_Translations::text_please_select() . ' ' . WBTM_Translations::text_pickup_point(); ?></option>
