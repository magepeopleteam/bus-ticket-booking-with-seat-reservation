(function ($) {
    ...
    function mage_seat_selection(target, is_sub) {
        ...
        if (target.hasClass('mage_selected')) {
            ...
            parents.find('.mage_bus_selected_seat_list [data-seat-name="' + seatName + '"]').slideUp(200, function () {
                ...
                parents.find('.mage_bus_sub_total .mage_bus_sub_total_price').html(php_vars.currency_symbol + '<span class="price-figure">' + totalPP + '</span>');
    ...
    function mageCustomRegField($this, seatType, qty, onlyES = false) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                $('#wbtm-form-builder .wbtm-loading').show();
            },
            success: function (data) {
                ...
                if (data !== '') {
                    ...
                    $("#wbtm-form-builder-" + s).empty();
                }
                $('#wbtm-form-builder .wbtm-loading').hide();
            }
        });
    }
