...
<div class="wbtm-bus-lists">
	...
	<div>
		...
		<ul>
			...
			<li>
				<strong><?php echo $wbtmmain->bus_get_option('wbtm_fare_text', 'label_setting_sec') ? $wbtmmain->bus_get_option('wbtm_fare_text', 'label_setting_sec') : _e('Fare', 'bus-ticket-booking-with-seat-reservation'); ?></strong> <?php echo get_woocommerce_currency_symbol() . $wbtmmain->wbtm_get_bus_price($bp, $dp, $price_arr); ?>
			</li>
		</ul>
