		...
		<form action="<?php echo $form_url; ?>" method="get" class="mage_form">
			...
			<div class="mage_form_list">
				<label>
					...
					<input type="text" class="mage_form_control" id="j_date" name="j_date" value="<?php echo mage_bus_isset( 'j_date' ); ?>" placeholder="<?php echo current_time( get_option( 'date_format' ) ); ?>" autocomplete="off" required/>
